...
import { Linkedin, Github, ChevronDown, ArrowRight } from 'lucide-react'
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen relative overflow-hidden flex items-center">
      <section id="her" className="min-h-screen flex items-center justify-center w-full">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            >
              SDE Intern @ Intellect Design Arena · MCA @ NIT Bhopal
            </motion.p>
            ...
            >
              ...
              {/* <a
                href="https://drive.google.com/file/d/1N7JyqLWDiefTxuoRUiJoJJHFfFMpv5ee/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-green-500 transition-colors duration-300 text-sm flex items-center"
              >
                View Resume
              </a> */}
            </motion.div>
            ...
            >
              {[
                { name: "LeetCode · 1556", url: "https://leetcode.com/u/kshitijratnawat/" },
